...
<section class="content">
		...
		<div class="box-body">
			<div class="table-responsive">
				<table id="example1" class="table table-bordered table-striped">
				  ...
				  inner join tb_anggota a on s.NIM=a.NIM where status='PIN' order by tgl_pinjam desc");
	...
	<h4> *Note
		...
		<br> Denda sebesar <span style="color:red; font-weight:bold;">Rp 1.000/hari</span>.
	</h4>
</section>